            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              <li className="flex items-center gap-2">
                <div className="flex gap-1">
                  <a 
                    href="https://wa.me/79122434435" 
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-5 h-5 bg-[#25D366]/10 rounded-full flex items-center justify-center hover:bg-[#25D366]/20 transition-colors"
                    aria-label="WhatsApp"
                  >
                  ...
                  <a 
                    href="https://t.me/+79122434435" 
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-5 h-5 bg-[#0088cc]/10 rounded-full flex items-center justify-center hover:bg-[#0088cc]/20 transition-colors"
                    aria-label="Telegram"
                  >
                    <svg className="w-3 h-3" fill="#0088cc" viewBox="0 0 24 24">
                      <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.894 8.221l-1.97 9.28c-.145.658-.537.818-1.084.508l-3-2.21-1.446 1.394c-.14.18-.357.295-.6.295-.002 0-.003 0-.005 0l.213-3.054 5.56-5.022c.24-.213-.054-.334-.373-.121l-6.869 4.326-2.96-.924c-.64-.203-.658-.64.135-.954l11.566-4.458c.538-.196 1.006.128.832.941z"/>
                    </svg>
                  </a>
                </div>
                <a href="tel:+79122434435" className="hover:text-primary transition-colors">
                  +7 912 243 44 35
                </a>
              </li>
              <li className="flex items-center gap-2">
